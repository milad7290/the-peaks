...
const StoryDetails: FC = () => {
  ...
  useEffect(() => {
    myRef.current.innerHTML = testStory.fields.body;
    getData();
  }, []);
        ...
        <div className="details-section">
          <div className="top-info">
            ...
            <span className="article-publish-date">
              {moment(testStory.webPublicationDate).format(
                "ddd DD MMM YYYY hh.mm"
              )}{" "}
              BST
            </span>
            <h1>{testStory.fields.headline}</h1>
            <h3>{testStory.fields.trailText}</h3>
          ...
          <div className="bottom-info">
            ...
            <div className="article-image">
              <img
                alt={testStory.webTitle}
                className="back-image"
                src={testStory.fields.thumbnail}
              />
              <p>
